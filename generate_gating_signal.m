function [gating_signal, gating_signal_test, gating_signal_test2] = generate_gating_signal(ksp2,params)
...
switch params.gatingmethod
    ...
    case 'PCA'
        ...
        [gating_signal, ~, gating_signal_test, gating_signal_test2] = PCA_gating_signal(ksp2,params);
    case 'ICA'
